    ...
    <div>
      ...
      {loading ? (
        ...
        <div className="text-center py-12 bg-white rounded-xl border border-gray-200">
          ...
          <p className="text-sm text-gray-400 mt-1">Accepted lesson requests with dates will appear here</p>
        </div>
      ) : (
        <div className="space-y-3">
          {bookings.map((booking) => (
            <div key={booking.id} className="bg-white rounded-xl border border-gray-200 p-5">
              ...
              {booking.message && (
                <p className="text-sm text-gray-500 mb-3 line-clamp-2">{booking.message}</p>
              )}
              {booking.status === "upcoming" && (
                <div className="flex gap-2">
                  ...
                  <button
                    ...
                    className="text-sm text-red-600 hover:text-red-700 font-medium px-4 py-1.5"
                  >
                    Cancel
                  </button>
                </div>
